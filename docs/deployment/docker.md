...
## Read Next
If you're having issues, take a look at the [Troubleshooting Guide](/docs/troubleshooting).

For more detailed Docker setup and management guides, see the [Management Docs](/docs/management):
- [Updating](/docs/management#updating)
- [Backing Up](/docs/management#backing-up)
- [Healthchecks](/docs/management#healthchecks)
- [File Ownership and Permissions](/docs/management#file-ownership-and-permissions)
- [Passing in Environmental Variables](/docs/management#passing-in-environmental-variables)
- [Auto-Starting at System Boot](/docs/management#auto-starting-at-system-boot)
- [Verifying Releases](/docs/management#verifying-releases)
- [Container Security](/docs/management#container-security)
