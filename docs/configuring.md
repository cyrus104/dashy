...
- **REST API** _(see [API docs](/docs/api))_
...
**`searchEngine`** | `string` | _Optional_ | Set the key name for your search engine. Can also use a custom engine by setting this property to `custom`. See the [searching docs](/docs/searching#setting-search-engine) for the full list of built-in keys. Defaults to `duckduckgo`
